...
// Функция для вывода всех предприятий и их отделов с количеством сотрудников

  function displayEnterprises(enterprises) {
    enterprises.forEach(enterprise => {
      const totalEmployees = getTotalEmployees(enterprise.departments);
      console.log(`${enterprise.name} (${totalEmployees ? totalEmployees + ' сотрудников' : 'нет сотрудников'})`);
      
      enterprise.departments.forEach(department => {
        console.log(`- ${department.name} (${department.employees_count ? department.employees_count + ' сотрудников' : 'нет сотрудников'})`);
      });
    });
  }
  
  // Функция для подсчета общего количества сотрудников в отделах
  function getTotalEmployees(departments) {
